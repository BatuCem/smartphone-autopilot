...
%This function will use the accelerometer, gyrometer, magnometer 
...
if isempty(firstRun)
  ...
  Q = N_Q*eye(4); %identity matrix
     
  R = N_R*eye(6); %identitty matrix

  x = [1 0 0 0]';  %state matrix
  P = N_P*eye(4); %identitiy matrix
...
%quaternion values for estimation
q0 = x(1);
q1 = x(2);
q2 = x(3);
q3 = x(4);
